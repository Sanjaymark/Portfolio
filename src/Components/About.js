    ...
    return(
        <div className="flex w-full mt-20 ">
            <div className="grid h-full m-1 w-3/5">
                <div>
                    <div className="m-2 ">
                        <span className="text-6xl heading p-2 hover-effect1 animate__bounce">About Me</span>
                    </div>
                    <div className=" paras text-lg italic hover-effect2 hover-p">
